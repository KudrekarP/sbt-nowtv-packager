package com.nowtv.sbt.packager.docker

import com.typesafe.sbt.SbtNativePackager.Universal
import com.typesafe.sbt.packager.Keys._
import com.typesafe.sbt.packager.archetypes.{JavaAppAshScript, JavaAppPackaging}
import sbt.Keys._
import sbt._
...
/**
  ...
  * }}}
  */
object NowTVAshScriptPlugin extends AutoPlugin {
  ...
  override def projectSettings = Seq(
    makeBashScript <<= (bashScriptDefines, target in Universal, executableScriptName, sourceDirectory) map makeUniversalAshScript,
  ...
  def makeUniversalAshScript(defines: Seq[String], tmpDir: File, name: String, sourceDir: File): Option[File] =
  ...
  private def resolveTemplate: URL = {
    getClass.getClassLoader.getResource(s"docker/$ashTemplate")
  }
}
